...
class BPRMF(UserItemArch):
    ...
    #     params = [
    #         {'params': Item.parameters(), 'embedding': True},
    #         {'params': User.parameters(), 'embedding': False},
    #     ]
    #     return params
...
def main():
    ...
    graph = get_graph(cfg, dataset, NUM_PADS=0, itemonly=False)
